            ...
            <tr>
                <td align="center">
                    <table role="presentation" style="width: 700px; background-color: #fff; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); padding: 50px 30px; text-align: center;">
                        ...
                        <tr>
                            <td>
                                <p style="font-size: 17px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; margin: 20px 0 0; text-align: left;">Recebemos os seus dados e estamos a um passo de finalizar o seu cadastro. Nos informe o código abaixo para que possamos liberar o seu acesso em nosso sistema.</p>
                            </td>
                        </tr>
                        <tr>
